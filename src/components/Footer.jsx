...
const Footer = () => {
  ...
  return (
    <div style={{ height: "250px", marginTop: '100px' }} className='mt-5 w-full bg-blue-400 text-white p-4'>
      <div className="flex justify-between p-4">
        ...
        <div className="flex flex-col">
          ...
          <a href="https://react.dev/" style={{ textDecoration: 'none', color: 'white' }}
            target='blank'>React</a>
          <a href="https://react-bootstrap.netlify.app/" style={{ textDecoration: 'none', color: 'white' }}
            target='_blank'>React Bootstrap</a>
          <a href="https://www.npmjs.com/package/react-router-dom" style={{ textDecoration: 'none', color: 'white' }}
        ...
        <div className='flex flex-col'>
          ...
          <div className="icons flex justify-between mt-3">
            ...
            <a href="https://github.com/" style={{ textDecoration: 'none', color: 'white' }} target='_blank'><i
      ...
      <p className='text-center mt-3 text-white'>Copyright &copy; May 2025 Batch, E-cart. Built with
         React/Redux.</p>
    </div>
